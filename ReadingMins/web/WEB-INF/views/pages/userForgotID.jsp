        ...
        <tr>
            <td>
                <table class="boxcenter">
                    <tr class="textcenter">
                        <td>
                            <div class="pagehead">Retrieve User ID</div>
                        </td>
                    </tr>
                    <form:form method="post" modelAttribute="retrieveUserID" action="">
                    <tr>
                        <td>
                            <table>
                                <tr>
                    ...
                    <tr class="textcenter">
                        <td>
                            <table class="boxcenter">
                                <tr>
                                    <td>
                                        <button type="submit" name="sendUserID" class ="button" >Send User ID</button>
                                    </td>
                                    <td>
